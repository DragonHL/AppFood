...
public class Account_Admin_FragmentActivity extends Fragment {

    Button btnAccountEdit, btnMonandatao, btnMonandathuchien, btnMonanyeuthich, btnDoimatkhau, btnDangxuat, btn_monanpheduyet;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.account_admin_fragment, container, false);
        ...
        btn_monanpheduyet = view.findViewById(R.id.btn_monanpheduyet);
    ...
    private void pheduyetMonAn() {

        btn_monanpheduyet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), DanhSach_MonAn_DoiPheDuyet.class);
