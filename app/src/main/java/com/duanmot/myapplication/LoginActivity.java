...
//                    if(firebaseUser.getEmail().equals("test@gmail.com") ){
...
//                    }
    ...
    private void loginAdmin(String email, String passw) {
        ...
        firebaseAuth2.signInWithEmailAndPassword(email, passw)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(LoginActivity.this, ManHinhChinh_Admin.class));
                            finish();
